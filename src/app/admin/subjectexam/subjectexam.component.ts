...
export class SubjectexamComponent implements OnInit {
  ...
  public RowSelected(j:number,class_id:number,exam_id:string,exam_subject_id:string,exam_class_id:number,class_name:string,exam_type:string,subject_id:number,exam_subject_type:string,exam_subject_marks:string,exam_subject_date:Date,exam_subject_start_time:string,exam_subject_end_time:string)
  {
